...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.user'
        db.add_column(u'task_tracker_discussion', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.user'
        db.delete_column(u'task_tracker_discussion', 'user_id')
