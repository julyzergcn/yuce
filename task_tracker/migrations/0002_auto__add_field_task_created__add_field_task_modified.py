...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'task_tracker_task', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Task.modified'
        db.add_column(u'task_tracker_task', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'task_tracker_task', 'created')

        # Deleting field 'Task.modified'
        db.delete_column(u'task_tracker_task', 'modified')
