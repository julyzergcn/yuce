...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bet.win_score'
        db.delete_column(u'core_bet', 'win_score')

        # Adding field 'Bet.profit'
        db.add_column(u'core_bet', 'profit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Bet.win_score'
        db.add_column(u'core_bet', 'win_score',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=8),
                      keep_default=False)

        # Deleting field 'Bet.profit'
        db.delete_column(u'core_bet', 'profit')
