...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.approved_date'
        db.add_column(u'core_topic', 'approved_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Topic.rejected_date'
        db.add_column(u'core_topic', 'rejected_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Topic.cancelled_date'
        db.add_column(u'core_topic', 'cancelled_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.approved_date'
        db.delete_column(u'core_topic', 'approved_date')

        # Deleting field 'Topic.rejected_date'
        db.delete_column(u'core_topic', 'rejected_date')

        # Deleting field 'Topic.cancelled_date'
        db.delete_column(u'core_topic', 'cancelled_date')
